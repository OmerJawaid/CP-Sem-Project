...
int main()
{
	...
	do
	{
		...
		if (choice == "a")
		{
			...
			{
				{
					...
					// Quest1
					cout << endl
						 << GREEN_TEXT << quest_without_fight[0].name << RESET_COLOR << endl;
					cout << "----------------------------------------------------";
					display_character_info();
					cout << "----------------------------------------------------" << endl;
					do
				...
				cout << endl
					 << GREEN_TEXT << quest_without_fight[1].name << RESET_COLOR << endl;
				cout << "----------------------------------------------------";
				display_character_info();
				cout << "----------------------------------------------------" << endl;
				{
			...
			{
				cout << endl
					 << character.name << " now had gathered the information required and fixed his path to the market he started moving towards the market but on the way, he encountered multiple ways to reach the market. " << endl
				...
				if (chap2_st_choice == "a" || chap2_st_choice == "A")
				{
					...
					cout << "----------------------------------------------------" << endl;
					{
						...
						do
						{
							...
							if (quest4_path_choice == "a" || quest4_path_choice == "A")
							{
								cout << character.name << " push the guards in front and start to run but suddenly 3 Frostbane guards came across" << endl
									 ...
									 << endl
									 << character.name << "Started to fight" << endl;
						...
						cout << character.name << " starts to walk for the zipline but in fog the player ends up going toward the Bilzzard Golem (The Second Boss of Mythical creatures). " << endl
							 << "\t" << character.name << " asks the same : "
							 << "What is happening here? Who are you and what are you doing here?";
				...
				else if (chap2_st_choice == "b" || chap2_st_choice == "B")
				{
					...
					cout << RED_TEXT << chapter.name[2] << RESET_COLOR << endl;
					{
						cout << character.name << " followed the map but in the middle of the map he was following he got attacked by first mythical creature's boss Snow Shuriken Ninja. " << endl
							 << endl
...
void character_creation()
{
	...
	do
	{
		...
		if (character.name == "")
			cout << "Empty character name!" << endl;
...
bool battle_system(int creaturenumber, int guard_number, int difficulty)
{
	...
	cout << "-------------------------------------------------------------------" << endl;
	cout << endl
		 << creature[creaturenumber].name << " " << guard_number << endl;
	do
	{
